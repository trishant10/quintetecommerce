...
if(isset($_POST['submit']))
{
  ...
  {     
        ...
        $contactNo=$_POST['register_number'];
    ...
    {  
      ...
      if(mysqli_num_rows($result) > 0)
        ...
        else
        {
          ...
          $query ="INSERT INTO users (Fullname, ContactNo, Address, UserName, Password, UserType) VALUES ('$fullname', '$contactNo', '$address'
      ...
      else
      {
        ...
        {
          $query ="INSERT INTO vendor_user (Fullname, ContactNo, Address, UserName, Password, UserType) VALUES ('$fullname', '$contactNo', '$address', '$username','$password', '$usertype')";
          $result=mysqli_query($con,$query);
          echo'
                <script type="text/javascript">
                 alert("Successfully Registered!!!");
