...
if (mysqli_num_rows($result) > 0) {
  while ($row = mysqli_fetch_assoc($result)) {
    ...
    echo '
        <form method="GET" action="cart.php?action=add&ID=' . $PID . '"& Vid="' . $Vid . '";>  
    ...
    echo '   <br><br>
        ...
        <button type="submit" name="" class="" style="color: white; text-decoration: none;"> <i class="fa fa-shopping-cart"></i>&nbsp ADD TO CART &nbsp |&nbsp PRICE : Rs. ' . $row["Price"] . ' (
    ...
    echo '
<div class="side">
<h2 style="background-color: #0E355A; padding: 10px; color: white;"> SUGGESTION </h2>
  ...
  <div class="column1">
    <div class="card" >
      ...
      <div class="container">
        <hr>
        <h2>Three Mistakes of My life</h2>
        <h3> Rs. 600 </h3>
        <a href="cart.php?ID=NEW-22&Vid=vendor1&Quantity=1"><p><button><i class="fa fa-fw fa-cart-plus"></i>ADD TO CART</button></p></a>
      </div>    
  </div>
  ...
  <div class="column1">
    <div class="card">
      ...
      <div class="container">
        ...
        <h2>Summer Love</h2>
        <h3> Rs. 600 </h3>
        <a href="cart.php?ID=NEW-21&Vid=vendor1&Quantity=1"><p><button><i class="fa fa-fw fa-cart-plus"></i>ADD TO CART</button></p></a>
      </div>    
  </div>
...
<footer class="footer-distributed">
  ...
  <div class="footer-center">
    ...
    <div>
      ...
      <p>
        <!-- <a href="mailto:info@quintet.com"> -->info@quintet.com</a></p>
    </div>
  </div>
