...
if(!isset($_SESSION['user']))
{
     ...
     ?><script type="text/javascript">alert("Please login to Continue");</script>
        <script type="text/javascript">window.open('login/login1.php','_self');
...
if(mysqli_num_rows($result)>0)
 ...
 ?>
  ...
  <div class="side" style="flex: 20%;">
    <h2> CART BILL</h2>
      <?php
      echo"<hr><h3> TOTAL AMOUNT : Rs. ".$total." <h3><hr><br>";
      echo'<input type="text" id="address" name="addres" placeholder="Enter your shipping address here"><br><br>';
      ?>  
